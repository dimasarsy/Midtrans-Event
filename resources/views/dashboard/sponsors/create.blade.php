...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"> <i class="fas fa-fw fa-dollar-sign"></i> Add New Sponsor</h1>
</div>

<div class="card shadow mb-4">
    <div class="col-lg-10">
        <div class="card-body">
            <form action="/dashboard/sponsors" method="POST" novalidate enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary mb-5">Add Sponsor</button>
            </form>
        </div>
    </div>
</div>
